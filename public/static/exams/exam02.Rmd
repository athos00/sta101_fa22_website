...
# Find your exam 2 instructions on **gradescope**:

`Dashboard` > `Exam02` > `Download Exam02 PDF`
...
-   The instructor will provide code debugging if needed, but this will
    result in a **grade penalty**. Note: ask questions early. Questions asked between 6:00pm and 11:59pm Monday the 14th may not be answered. 
