...
- Go to [https://www.latex-project.org/get/](https://www.latex-project.org/get/) and scroll down to download the LaTeX package for your device. [MacTeX](https://tug.org/mactex/) for macs or [MiKTeX](https://miktex.org/) for Windows.
...
:::{.callout-note}
In future labs, we will render to pdf directly but currently, RStudio containers are not setup with the tools to render to PDF directly.
:::
