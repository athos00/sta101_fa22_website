...
We approximate $\mu$ by $\bar{x}$ and $\sigma$ by the same standard deviation $s$. However $s$ may be smaller than $\sigma$ and our confidence interval could be too narrow, for example, run the code below:
