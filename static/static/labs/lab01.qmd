...
:::callout-note Notice in the YAML the output is set to "pdf". In this course, all assignments **must be submitted to gradescope as PDFs**. To avoid issues that can occur while rendering, it is a good idea to render frequently. **At least after every exercise**. :::
