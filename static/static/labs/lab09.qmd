...
author: "STA 101"
subtitle: "Due Thursday November 17 at 11:59pm"
format: html
css: "labs2.css"
---
...
- The binomial distribution counts the number of "successes" in a series of independent experiments. Two parameters characterize the binomial distribution: $n$, the total number of trials and $p$ the probability of an individual success. Example: A season of Duke basketball games can be modeled as a binomial distribution where $n$ is the total number of games in the season and $p$ is the probability of Duke winning and individual game. Here we assume that Duke has the same probability of winning regardless of the team they play.
